...
<div class="pull-left">
<h6 class="panel-title txt-dark">Hospital Details</h6>
</div>
...
<form action="?page=hospitals" method="post" enctype="multipart/form-data">
...
<div class="col-md-4">
<div class="form-group">
<label class="control-label mb-10" for="exampleInputEmail_1">Hospital Title English</label>
<div class="input-group">
...
<div class="col-md-8">
<div class="form-group">
<label class="control-label mb-10" for="exampleInputEmail_1">Hospital Details English</label>
<div class="input-group">
...
<div class="col-md-4">
<div class="form-group">
<label class="control-label mb-10" for="exampleInputEmail_1">Hospital Title Arabic</label>
<div class="input-group">
<div class="input-group-addon"><i class="fa fa-header"></i></div>
...
<div class="col-md-8">
<div class="form-group">
<label class="control-label mb-10" for="exampleInputEmail_1">Hospital Details Arabic</label>
<div class="input-group">
<div class="input-group-addon"><i class="fa fa-file-text-o"></i></div>
...
if ( !isset($_GET["edit"]) ){
$status 		= array('0','1');
$arrayOfTitles 	= array('Active Hospitals','Inactive Hospitals');
...
<a href="?page=hospitals&edit=1&id=<?php echo $row["id"] ?>" style="margin:3px"><i class="fa fa-edit"></i></a>

<a href="?page=imageGallery&id=<?php echo $row["id"] ?>" style="margin:3px"><i class="fa fa-image"></i></a>

<?php /*<a href="?page=videoGallery&id=<?php echo $row["id"] ?>" style="margin:3px"><i class="fa fa-play "></i></a> */?>

<?php /* <a href="?page=addFilter&id=<?php echo $row["id"] ?>" style="margin:3px"><i class="fa fa-filter "></i></a> */ ?>

<a href="?page=hospitals&<?php echo $action[$i] . $row["id"] ?>" style="margin:3px"><i class="<?php echo $icon[$i] ?>"></i></a>
