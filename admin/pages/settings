...
<div class="pull-left">
<h6 class="panel-title txt-dark">Tag Details</h6>
</div>
...
<form action="?page=tags" method="post" enctype="multipart/form-data">
...
<a href="?page=tags&edit=1&id=<?php echo $row["id"] ?>" style="margin:3px"><i class="fa fa-edit"></i></a>

<a href="?page=tags&<?php echo $action[$i] . $row["id"] ?>" style="margin:3px"><i class="<?php echo $icon[$i] ?>"></i></a>
