...
<form action="?page=packages" method="post" enctype="multipart/form-data">
...
<div class="col-md-4">
<div class="form-group">
<label class="control-label mb-10" for="exampleInputEmail_1">Package Title English</label>
<div class="input-group">
...
<div class="col-md-8">
<div class="form-group">
<label class="control-label mb-10" for="exampleInputEmail_1">Package Details English</label>
<div class="input-group">
...
<div class="col-md-4">
<div class="form-group">
<label class="control-label mb-10" for="exampleInputEmail_1">Package Title Arabic</label>
<div class="input-group">
<div class="input-group-addon"><i class="fa fa-header"></i></div>
...
<div class="col-md-8">
<div class="form-group">
<label class="control-label mb-10" for="exampleInputEmail_1">Package Details Arabic</label>
<div class="input-group">
<div class="input-group-addon"><i class="fa fa-file-text-o"></i></div>
...
<input type="text" class="form-control" id="exampleInputEmail_1" placeholder="Enter phone" name="mobile" <?php if(isset($_GET["edit"])){?>value="<?php echo $data[0]["mobile"] ?>"<?php }?>>
</div>
</div>
</div>	
...
<div class="input-group">
<div class="input-group-addon"><i class="fa fa-phone"></i></div>
<input type="text" class="form-control" id="exampleInputEmail_1" placeholder="Price" name="price" <?php if(isset($_GET["edit"])){?>value="<?php echo $data[0]["price"] ?>"<?php }?>required>
</div>
</div>
</div>	
...
<div class="input-group">
<div class="input-group-addon"><i class="fa fa-phone"></i></div>
<input type="text" class="form-control" id="exampleInputEmail_1" placeholder="Number of points" name="points" <?php if(isset($_GET["edit"])){?>value="<?php echo $data[0]["points"] ?>"<?php }?>required>
</div>
</div>
</div>	
...
<div class="input-group">
<div class="input-group-addon"><i class="fa fa-phone"></i></div>
<input type="text" class="form-control" id="exampleInputEmail_1" placeholder="Number in days" name="validity" <?php if(isset($_GET["edit"])){?>value="<?php echo $data[0]["validity"] ?>"<?php }?>required>
</div>
</div>
</div>	
...
if ( !isset($_GET["edit"]) ){
$status 		= array('0','1');
$arrayOfTitles 	= array('Active Packages','Inactive Packages');
...
<a href="?page=packages&edit=1&id=<?php echo $row["id"] ?>" style="margin:3px"><i class="fa fa-edit"></i></a>

<a href="?page=packages&<?php echo $action[$i] . $row["id"] ?>" style="margin:3px"><i class="<?php echo $icon[$i] ?>"></i></a>
