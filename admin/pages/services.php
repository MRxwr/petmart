...
<div class="pull-left">
<h6 class="panel-title txt-dark">Service Details</h6>
</div>
...
<form action="?page=services" method="post" enctype="multipart/form-data">
...
<div class="col-md-4">
<div class="form-group">
<label class="control-label mb-10" for="exampleInputEmail_1">Service Title English</label>
<div class="input-group">
...
<div class="col-md-8">
<div class="form-group">
<label class="control-label mb-10" for="exampleInputEmail_1">Service Details English</label>
<div class="input-group">
...
<div class="col-md-4">
<div class="form-group">
<label class="control-label mb-10" for="exampleInputEmail_1">Service Title Arabic</label>
<div class="input-group">
<div class="input-group-addon"><i class="fa fa-header"></i></div>
...
<div class="col-md-8">
<div class="form-group">
<label class="control-label mb-10" for="exampleInputEmail_1">Service Details Arabic</label>
<div class="input-group">
<div class="input-group-addon"><i class="fa fa-file-text-o"></i></div>
...
if ( !isset($_GET["edit"]) ){
$status 		= array('0','1');
$arrayOfTitles 	= array('Active Services','Inactive Services');
...
<a href="?page=services&edit=1&id=<?php echo $row["id"] ?>" style="margin:3px"><i class="fa fa-edit"></i></a>

<?php /*<a href="?page=imageGallery&id=<?php echo $row["id"] ?>" style="margin:3px"><i class="fa fa-image"></i></a>*/?>
...
<a href="?page=services&<?php echo $action[$i] . $row["id"] ?>" style="margin:3px"><i class="<?php echo $icon[$i] ?>"></i></a>
